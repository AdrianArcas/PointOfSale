...
<t:pageTemplate pageTitle="Process Sale">
  ...
  <div class="row row-cols-2 border-5 position-relative " style="height:92%;border-width: 5px;">
    <div class="col position-relative">
      <br>
      <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/ProcessSale">
        <input type="hidden" id="form1" name="form1" value="form1">
        <div class="input-group " style="height: 50px">
            <input type="text" class="form-control border border-2 border-primary" id="search_input" name="search_input" placeholder="" value="">
      ...
      <div class="container position-absolute bottom-0 start-0">
        ...
        <div class="row border-5 align-bottom fst-italic " style="font-size: 25px">
          <div class="col">
            ...
            <input type="number" id="quantity" name="quantity" min="0" max="${product.quantity}" style="width: 100px"> <%--la max vine pus ${product.quantityAvailable}--%>
          </div>
        </div>
        <br>
        <div class="row border-5" style="font-size: 25px">
          ...
          <div class="col col-4 text-center w-25">
            <button class="btn btn-primary input-group-append" type="submit" style="border-radius: 50%; font-size: 50px">
